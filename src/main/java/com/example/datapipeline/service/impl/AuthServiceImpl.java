...
import com.example.datapipeline.entity.User;
...
import com.example.datapipeline.repository.UserRepository;
import com.example.datapipeline.security.JwtTokenProvider;
import com.example.datapipeline.service.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String register(RegisterDto registerDto) {
        ...
        if(userRepository.existsByUsername(registerDto.getUsername())){
            throw new DataProcessingException(HttpStatus.BAD_REQUEST, "Username is already exists!.");
        }

        // add check for email exists in database
        if(userRepository.existsByEmail(registerDto.getEmail())){
            throw new DataProcessingException(HttpStatus.BAD_REQUEST, "Email is already exists!.");
        }
